    ...
    partial class Entity
    {
        protected virtual partial void DisassembleNextOpCode(int currentIndex, short opcode)
        {
            ...
            case OpCodeConst.Calli:
                {
                    // var sig = Module.ResolveSignature(ReadStreamHead<int>());
            ...
            case OpCodeConst.Callvirt:
                {
                    DisassembleNextCallvirt();
                }
                return;
            case OpCodeConst.Cpobj:
                {
                    var type = Module.ResolveType(ReadStreamHead<int>());
            ...
            case OpCodeConst.Ldstr:
                {
                    var str = Module.ResolveString(ReadStreamHead<int>());
                    PushOperation(Inst.Ldstr(str));
                }
                return;
            case OpCodeConst.Newobj:
                {
                    DisassembleNextNewobj();
                }
                return;
            ...
            case OpCodeConst.Ldfld:
                {
                    var fld = Module.ResolveField(ReadStreamHead<int>());
            ...
            case OpCodeConst.Ldftn:
                {
                    DisassembleNextLdftn();
                }
                return;
            case OpCodeConst.Ldvirtftn:
                {
                    DisassembleNextLdvirtftn();
                }
                return;
