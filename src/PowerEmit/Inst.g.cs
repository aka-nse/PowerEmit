...
partial struct Inst
{
    ...
    /// <param name="operand"> The operand to emit. </param>
    /// <returns> The built emitter. </returns>
    public static Inst<ImmutableArray<Label>> Switch(ImmutableArray<Label> operand)
        => new Inst<ImmutableArray<Label>>(OpCodes.Switch, operand, null);

    /// <summary> Gets emitter to emit switch. </summary>
    /// <param name="operand"> The operand to emit. </param>
    /// <returns> The built emitter. </returns>
    public static Inst<ImmutableArray<LabelBuilder>> Switch(ImmutableArray<LabelBuilder> operand)
        => new Inst<ImmutableArray<LabelBuilder>>(OpCodes.Switch, operand, null);
