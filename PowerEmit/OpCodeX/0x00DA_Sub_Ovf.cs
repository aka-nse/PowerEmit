...
namespace PowerEmit
{
    ...
    {
        /// <summary> Creates new instruction item of <c>sub.ovf</c>. </summary>
        /// <returns></returns>
        public static IILStreamInstruction Sub_Ovf()
            => new Emit_Sub_Ovf();


        private sealed class Emit_Sub_Ovf : ILStreamInstruction
        {
