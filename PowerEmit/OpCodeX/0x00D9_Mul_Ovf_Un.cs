...
namespace PowerEmit
{
    ...
    {
        /// <summary> Creates new instruction item of <c>mul.ovf.un</c>. </summary>
        /// <returns></returns>
        public static IILStreamInstruction Mul_Ovf_Un()
            => new Emit_Mul_Ovf_Un();


        private sealed class Emit_Mul_Ovf_Un : ILStreamInstruction
        {
