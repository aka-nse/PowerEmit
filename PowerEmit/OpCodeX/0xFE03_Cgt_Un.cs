...
namespace PowerEmit
{
    ...
    {
        /// <summary> Creates new instruction item of <c>cgt.un</c>. </summary>
        /// <returns></returns>
        public static IILStreamInstruction Cgt_Un()
            => new Emit_Cgt_Un();


        private sealed class Emit_Cgt_Un : ILStreamInstruction
        {
