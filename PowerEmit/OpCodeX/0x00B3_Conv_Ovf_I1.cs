...
namespace PowerEmit
{
    ...
    {
        /// <summary> Creates new instruction item of <c>conv.ovf.i1</c>. </summary>
        /// <returns></returns>
        public static IILStreamInstruction Conv_Ovf_I1()
            => new Emit_Conv_Ovf_I1();


        private sealed class Emit_Conv_Ovf_I1 : ILStreamInstruction
        {
            ...
            public override void Invoke(IILInvocationState state)
            {
                checked
                {
                    ...
                    var resultValue = value switch
                    {
                        ...
                        StackValue.IFloat x => StackValue.FromValue((sbyte)Math.Truncate(x.Value)),
                        _ => throw new Exception(),
                    };
