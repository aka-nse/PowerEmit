...
namespace PowerEmit
{
    ...
    {
        /// <summary> Creates new instruction item of <c>rem.un</c>. </summary>
        /// <returns></returns>
        public static IILStreamInstruction Rem_Un()
            => new Emit_Rem_Un();


        private sealed class Emit_Rem_Un : ILStreamInstruction
        {
